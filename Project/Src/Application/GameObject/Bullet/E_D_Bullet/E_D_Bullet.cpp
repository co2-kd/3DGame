#include "E_D_Bullet.h"
#include"../../../Scene/SceneManager.h"
#include"../../../main.h"

void E_D_Bullet::Init()
{
	if (!m_spModel)
	{
		m_objectType = ObjectType::E_Bullet;
		m_spModel = std::make_shared<KdModelWork>();
		m_spModel->SetModelData("Asset/Models/Bullet/E_D_Bullet/E_D_Bullet.gltf");
	}
	m_timelimit = 100.0f;
	m_pDebugWire = std::make_unique<KdDebugWireFrame>();
}

void E_D_Bullet::Update()
{
	//弾の生存時間
	m_timelimit--;
	if (m_timelimit < 0)
...
void E_D_Bullet::UpdateCollision()
{
